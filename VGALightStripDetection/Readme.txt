...
[v2.0.1.10] - 2021.12.15
1. 摄像头改换成HF868-2, 在1280*720分辨率下, 为60fps
2. 将帧率设定开到配置档中, 程式依据fps 来设定waitKey 时间, 默认为30fps
3. ConfigData::instance() 重新替换成kConfig
4. 新增Camera FPS 工具项目, 用来查看相机的帧率, 也可以在无相机工具的系统中充当相机软件使用